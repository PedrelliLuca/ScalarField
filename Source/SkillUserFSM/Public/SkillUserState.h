...
public:
	virtual TObjectPtr<USkillUserState> OnTargeting(TObjectPtr<APlayerController> controller) PURE_VIRTUAL(USkillUserState::OnTargeting, return nullptr;);
	...
	virtual TObjectPtr<USkillUserState> OnTick(float deltaTime, TObjectPtr<APlayerController> controller) PURE_VIRTUAL(USkillUserState::Tick, return nullptr;);

...
public:
    virtual TObjectPtr<USkillUserState> OnTargeting(TObjectPtr<AActor> target, TObjectPtr<AController> controller)
        PURE_VIRTUAL(USkillUserState::OnTargeting, return nullptr;);
    virtual TObjectPtr<USkillUserState> OnBeginSkillExecution(TObjectPtr<UAbstractSkill> skill, TObjectPtr<AController> controller)
        PURE_VIRTUAL(USkillUserState::OnBeginSkillExecution, return nullptr;);

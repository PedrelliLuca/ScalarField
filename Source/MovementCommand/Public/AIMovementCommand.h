...
public:
	...
	/** \brief Needed to warn the Behavior Tree that we're (not) moving. This is needed because, by design, movement nodes in ScalarField do not stop the BT from flowing */

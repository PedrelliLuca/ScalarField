...
void UInventoryPresenterWidget::ShowInventory(TWeakInterfacePtr<IInventory> inventory) {
    ...
    _itemFromInventoryDiscardedHandle =
        _inventoryWidget->OnItemFromInventoryDiscarded().AddUObject(this, &UInventoryPresenterWidget::_onItemFromInventoryBeingDiscarded);
}
